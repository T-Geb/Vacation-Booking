package com.Project.Config;  // modified package address

/*This Rest Data Config file was already given as part of the initial set up for project*/

import com.Project.Entities.*;  // modified import address
